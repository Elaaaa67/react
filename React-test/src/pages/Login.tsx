...
import AuthenticationService from "../services/authentoficationSerivce";
type Field = {
    value?: any,
    error?: string,
    isValid?: boolean
...
const Login: FunctionComponent = () => {
    ...
    const [message, setMessage] = useState<string>('Vous êtes déconnecté.(Geko / altego123)');
...
const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    const validateForm = () => {
        ...
        if (form.username.value.length < 3) {
            const errorMsg: string = 'Votre prénom doit faire au moins 3 caractèresde long.';
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (isFormValid) {
            ...
            AuthenticationService.login(form.username.value,
...
px-4 py-3 rounded relative mt-2">
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            type="password"
                            name="password"
                            className="shadow appearance-none border rounded w-full py-2 px3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
